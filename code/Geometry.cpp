...
std::vector<float>
buildTexturedRect(Vector3 topLeft, Vector3 bottomLeft, Vector3 bottomRight, Vector3 topRight, Vector3 normal, float quality)
{
  std::vector<float> rect {
    //Bottom Left Triangle
    topLeft.m_x, topLeft.m_y, topLeft.m_z, //position
    normal.m_x, normal.m_y, normal.m_z, //normal
    0.0f, quality, //x, y cordinate to map to on texture
    bottomLeft.m_x, bottomLeft.m_y, bottomLeft.m_z, //position
    normal.m_x, normal.m_y, normal.m_z, //normal
    0.0f, 0.0f, //x, y cordinate to map to on texture
    bottomRight.m_x, bottomRight.m_y, bottomRight.m_z, //position
    normal.m_x, normal.m_y, normal.m_z, //normal
    quality, 0.0f, //x, y cordinate to map to on texture
    ...
    normal.m_x, normal.m_y, normal.m_z, //normal
    quality, 0.0f, //x, y cordinate to map to on texture
    topRight.m_x, topRight.m_y, topRight.m_z, //position
    normal.m_x, normal.m_y, normal.m_z, //normal
    quality, quality //x, y cordinate to map to on texture
  };
...
std::vector<float>
buildRect(Vector3 topLeft, Vector3 bottomLeft, Vector3 bottomRight, Vector3 topRight, Vector3 normal)
{
  std::vector<float> rect {
    //Bottom Left Triangle
    topLeft.m_x, topLeft.m_y, topLeft.m_z, //position
...
std::vector<float>
buildTexturedRect(Vector3 topLeft, Vector3 size, Vector3 normal, float quality)
{
  std::vector<float> temp = 
    buildTexturedRect(Vector3(topLeft.m_x, topLeft.m_y, topLeft.m_z), 
                      Vector3(topLeft.m_x, topLeft.m_y - size.m_y, topLeft.m_z + size.m_z), 
                      Vector3(topLeft.m_x + size.m_x, topLeft.m_y - size.m_y, topLeft.m_z + size.m_z), 
                      Vector3(topLeft.m_x + size.m_x, topLeft.m_y, topLeft.m_z), 
                      normal, 
                      quality
  );
  return temp;
...
std::vector<float>
buildRect(Vector3 topLeft, Vector3 size, Vector3 normal)
{
  std::vector<float> temp = 
    buildRect(Vector3(topLeft.m_x, topLeft.m_y, topLeft.m_z), 
                      Vector3(topLeft.m_x, topLeft.m_y - size.m_y, topLeft.m_z + size.m_z), 
                      Vector3(topLeft.m_x + size.m_x, topLeft.m_y - size.m_y, topLeft.m_z + size.m_z), 
                      Vector3(topLeft.m_x + size.m_x, topLeft.m_y, topLeft.m_z), 
                      normal
