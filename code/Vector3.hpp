...
public:
  ...
  /// \brief Returns a glm::vec3 version of the current vector.
  /// \return Returns a glm::vec3 version of the current vector.
  glm::vec3
  convert (); 

  /// \brief Sets this vector equal to a glm::vec3
  /// \param[in] v A glm::vec3 vector.
  /// \post This vector has the same components as the glm::vec3.
  /// \return This vector.
  Vector3&
